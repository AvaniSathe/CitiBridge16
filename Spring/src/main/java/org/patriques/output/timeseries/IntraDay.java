...
public class IntraDay extends TimeSeriesResponse {
   ...
   */
  public static IntraDay from(org.patriques.input.technicalindicators.Interval interval, String json)  {
  ...
  private static class Parser extends TimeSeriesParser<IntraDay> {
    private final org.patriques.input.technicalindicators.Interval interval;

    Parser(org.patriques.input.technicalindicators.Interval interval2) {
