...
public class TimeSeries {
   ...
   * @param oneMin the interval between two consecutive data points in the time series {@link Interval}
   ...
   */
  public IntraDay intraDay(String symbol, org.patriques.input.technicalindicators.Interval oneMin, OutputSize outputSize)  {
    String json = apiConnector.getRequest(new Symbol(symbol), Function.TIME_SERIES_INTRADAY, oneMin, outputSize);
    return IntraDay.from(oneMin, json);
  }
   ...
   * @return {@link IntraDay} time series data
   */
  public IntraDay intraDay(String symbol, org.patriques.input.technicalindicators.Interval interval)  {
